  ...
  return (
    <aside className="w-64 min-h-screen bg-neutral-900 flex flex-col">
      ...
      <div className="px-5 py-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-brand flex items-center justify-center shadow-lg shadow-brand/30">
            <span className="text-white font-bold text-sm">YIS</span>
          </div>
          <div>
            <p className="text-white font-semibold text-sm leading-tight">Yenepoya LMS</p>
            <p className="text-neutral-400 text-xs">School Management</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-white/10">
        ...
        <button
          onClick={logout}
          className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-neutral-400 hover:bg-white/10 hover:text-white transition-all"
        >
